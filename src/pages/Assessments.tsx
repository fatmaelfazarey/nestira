...
//       } else {
//         // The store function already sets the assessments state, but we need to transform the data
...
//                         >
//                           {getDisplayStatus(assessment.status)}
//                         </Badge> */}
//                       </div>
...
//                                 <p className="font-medium text-success">{assessment.score ? assessment.score + '%' : '-'}</p>
//                               </div>
//                               <div>
//                                 <span className="text-muted-c-foreground">Status:</span>
//                                 <p className="font-medium text-success">{assessment.status_score}</p>
//                               </div>
