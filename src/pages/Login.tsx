                    ...
                    <div className="w-full max-w-md">
                        ...
                        >
                            ...
                            <div className="text-right mb-6">
                                <a href="#" className="text-sm text-secondary-c hover:text-secondary-c-hover hover:underline font-medium">
                                    Forgot Password?
                                </a>
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-secondary-c text-secondary-c-foreground py-3 rounded-lg hover:bg-secondary-c-hover transition duration-200 font-semibold shadow-lg hover:shadow-xl disabled:bg-muted-c disabled:cursor-not-allowed flex items-center justify-center"
                            >
                                {loading ? (
