...
import { Input } from '@/components/ui/input';
import ProfileModal from '../talent-pool/ProfileModal';
                      ...
                      <div className='flex justify-between items-center w-full gap-1'>
                        ...
                        <div>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="flex gap-1 justify-center items-center hover:bg-gray-100"
                            onClick={(e) => {
                              e.stopPropagation();
                              handleOpenProfile(candidate.id);
                            }}
                          >
                            <span className="text-secondary-c">Profile</span>
                            <ExternalLink className='text-secondary-c w-4 h-4' />
                          </Button>
                        </div>
                      </div>
