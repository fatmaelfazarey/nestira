...
const SignAsCandidate = () => {
    ...
    const [basicInfo, setBasicInfo] = useState({
        ...
        businessEmail: '', linkedin: '', password: '', confirmPassword: '', role: '', profilePhoto: ''
    });
            ...
            <div className=" relative min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-8 px-4">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="text-center mt-8 text-sm text-gray-600">
                        ...
                        <p>Already have an account? <Link to="/login" className="text-secondary-c hover:underline font-medium">Sign In</Link></p>
                        <p>Register as an employer <Link to="/signup/employer" className="text-secondary-c hover:underline font-medium">Sign Up</Link></p>
                    </div>
                </div>
            </div>
        </>
...
export default SignAsCandidate
